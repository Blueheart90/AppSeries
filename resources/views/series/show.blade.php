                    ...
                    <div class="grid grid-cols-4 gap-4 p-10">
                        ...
                        <div class="col-span-3">
                            ...
                            <div x-data="{ selected: 'videos' }">
                                <div class="flex flex-col justify-between mb-4 sm:flex-row" x-ref="topNav">
                                    @php
                                        $navList = [
                                ...
                                <div
                                    ...
                                    >
                                    <div class="grid grid-cols-4 gap-4 sm:grid-cols-2 md:grid-cols-3 videoGallery">
                                ...
                                <div
                                    ...
                                    >
                                    <div class="grid grid-cols-4 gap-4 imageGallery">
