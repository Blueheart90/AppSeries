<x-guest-layout>
    ...
    <div class="p-20 pb-0 bg-blue-600 ">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, quod inventore incidunt consequuntur fugiat distinctio eligendi ipsa dolorem! Doloremque repellat nisi omnis vero qui corporis ad soluta iure ea ipsam.
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#2563EB" fill-opacity="1" d="M0,192L60,186.7C120,181,240,171,360,144C480,117,600,75,720,74.7C840,75,960,117,1080,133.3C1200,149,1320,139,1380,133.3L1440,128L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z">
        </path>
    </svg>
